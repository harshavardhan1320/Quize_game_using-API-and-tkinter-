...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.window.configure(padx=20, pady=20, background=THEME_COLOR, width=300, height=450)
    ...
    def next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.question_text, text="You've reached end of questions")
